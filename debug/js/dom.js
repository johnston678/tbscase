 ...
 */
function DOMImplementation(/* Object */
features) {
    this._features = {};
    if (features) {
...
function _insertBefore(parentNode, newChild, nextChild) {
    ...
    } while (newFirst !== newLast && (newFirst = newFirst.nextSibling))_onUpdateChild(parentNode.ownerDocument || parentNode, parentNode);
