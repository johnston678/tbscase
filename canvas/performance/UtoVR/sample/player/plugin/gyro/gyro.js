...
eval(function (p, a, c, k, e, d) {
    ...
    return p
}('6 2,a,5,7=c,8=c;3 b(){d(!7||8)f;2&&5.p(2.D());a=E(b)}3 F(h){5=h;7=k;2&&2.G();b()}3 B(){7=c;r(a);2&&2.u()}6 i=j l.v({n:"A"});i.J(3(g){2=g}).P(3(9){8=k;O.K(9)});3 o(4){d(!8)f;6 m=j l.H(4.x||0,4.y||0,4.z||0,4.w||1);5&&5.p(m)}L.N("9",3(t){6 e=t.q,4=e.q;I(e.n){s"C":o(4);M}});', 52, 52, '||deviceOrientation|function|Quat|playObj|var|enableGyro|enableIframeGyro|message|loopHander|gyroDraw|false|if||return|deviceOrientationController|bindPlayObj|promise|new|true|FULLTILT|Q|type|iframeGyroDraw|api_setMPMatrix|data|cancelAnimationFrame|case||stop|getDeviceOrientation|||||game|stopGyroEffect|gyroHelp|getScreenAdjustedQuaternion|requestAnimationFrame|addGyroEffect|start|Quaternion|switch|then|log|window|break|addEventListener|console|catch'.split('|'), 0, {}))
